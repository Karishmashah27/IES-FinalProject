...
namespace Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        //private object base64Credentials;
        ...
        public async Task<IActionResult> Secret()
        {
            var serverResponse = await AccessTokenRefreshWrapper(
                 () => SecuredGetRequest("https://localhost:44319/oauth/token"));
        ...
        private async Task RefreshAccessToken()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:44319/oauth/token")
            {
